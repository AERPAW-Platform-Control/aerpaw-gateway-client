...
class ExperimentApi(object):
    ...
    def create_experiment(self, body, **kwargs):  # noqa: E501
        ...
        :param Experiment body: Experiment Object (required)
        :return: ApiResponse
    ...
    def delete_experiment(self, experiment, **kwargs):  # noqa: E501
        """delete experiment  # noqa: E501

        delete/terminate experiment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_experiment(experiment, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str experiment: experiment to delete (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.delete_experiment_with_http_info(experiment, **kwargs)  # noqa: E501
        else:
            (data) = self.delete_experiment_with_http_info(experiment, **kwargs)  # noqa: E501
            return data

    def delete_experiment_with_http_info(self, experiment, **kwargs):  # noqa: E501
        """delete experiment  # noqa: E501

        delete/terminate experiment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_experiment_with_http_info(experiment, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['experiment', 'username', 'project']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def query_experiment(self, experiment, **kwargs):  # noqa: E501
        """get status of specific experiment  # noqa: E501

        get Experiment status of specific experiment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_experiment(experiment, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str experiment: experiment name to query (required)
        :param str username: username for the request
        :param str project: project name
        :return: Experiment
                 If the method is called asynchronously,
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.query_experiment_with_http_info(experiment, **kwargs)  # noqa: E501
        else:
            (data) = self.query_experiment_with_http_info(experiment, **kwargs)  # noqa: E501
            return data

    def query_experiment_with_http_info(self, experiment, **kwargs):  # noqa: E501
        """get status of specific experiment  # noqa: E501

        get Experiment status of specific experiment  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.query_experiment_with_http_info(experiment, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method query_experiment" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'experiment' is set
        if ('experiment' not in params or
                params['experiment'] is None):
            raise ValueError("Missing the required parameter `experiment` when calling `query_experiment`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'experiment' in params:
            path_params['experiment'] = params['experiment']  # noqa: E501
